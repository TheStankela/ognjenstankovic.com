        ...
        <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
            <div className="mx-auto max-w-screen-sm text-center lg:mb-16 mb-8">
                ...
                <div className="grid gap-8 max-w-screen-md mx-auto">
                   {posts.map(post => (
                    <article key={post.id} className="p-6 rounded-lg border  shadow-md bg-gray-800 border-gray-700 ">
                        ...
                        <h2 className="mb-2 text-2xl font-bold tracking-tight text-white"><a href="#">{post.title}</a></h2>
                    ...
                    <a type="button" className="bg-blue-900/90 hover:bg-sky-700 rounded-lg p-2 cursor-pointer">Prev</a>
                    <span className="mx-3 p-2">Page 1</span>
                    <a type="button" className="bg-blue-900/90 hover:bg-sky-700 rounded-lg p-2 cursor-pointer">Next</a>
                    </div>                 
                </div>  
        </div>
        <Connect/>
