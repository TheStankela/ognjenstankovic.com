...
export default function Newsletter() {
  return (
    <section className="py-12 bg_dark_blue">
            ...
            <div className="mx-auto max-w-screen-md sm:text-center">
                ...
                <form action="#">
                    <div className="items-center mx-auto mb-3 space-y-4 max-w-screen-sm sm:flex sm:space-y-0">
                        ...
                        <div>
                            <button type="submit" className="py-3 px-5 w-full text-sm font-medium text-center text-white rounded-lg border cursor-pointer bg-primary-700 border-primary-600 sm:rounded-none sm:rounded-r-lg hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 bg-primary-600 hover:bg-primary-700 focus:ring-primary-800">Subscribe</button>
                        </div>
                    </div>
                    <div className="mx-auto max-w-screen-sm text-sm text-left newsletter-form-footer text-gray-300">We care about the protection of your data. <span className="font-medium text-primary-600 text-primary-500">We will not share your email</span>.</div>
                </form>
            </div>
        </div>
    </section>
