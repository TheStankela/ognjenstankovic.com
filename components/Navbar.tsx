    ...
    <nav className="border-gray-200 bg-gray-900">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div className="hidden cursor-pointer w-full md:block md:w-auto" id="navbar-default">
                ...
                <li>
                    <a href="/blog" className="block py-2 pl-3 pr-4 rounded md:border-0 md:p-0 text-white md:hover:text-[#2880DA] hover:bg-[#2880DA] hover:text-white md:hover:bg-transparent">Blog</a>           
                </li>
                <li>
                    <a href="/sponsorship" className="block py-2 pl-3 pr-4 rounded md:border-0 md:p-0 text-white md:hover:text-[#2880DA] hover:bg-[#2880DA] hover:text-white md:hover:bg-transparent">Sponsorship</a>
                </li>
                <li>
                    <a href="/about" className="block py-2 pl-3 pr-4 rounded md:border-0 md:p-0 text-white md:hover:text-[#2880DA] hover:bg-[#2880DA] hover:text-white md:hover:bg-transparent">About</a>
                </li>
                </ul>
            </div>
        </div>
